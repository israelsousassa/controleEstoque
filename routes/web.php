...
Route::get('/produtos/fornecedor/remover/{id}', 'FornecedorController@remover')->where('id','[0-9]+');
Route::get('/produtos/fornecedor/alterar/{id}', 'FornecedorController@alterar');
Route::post('/produto/fornecedor/update/{id}','FornecedorController@update')->where('id','[0-9]+');
